...
skel.registerPlugin("layers", function(e) {
    function cn(e, r, i) {
        ...
        this.id = e, this.index = i, this[n] = {
            ...
            this[j] = t._.newDiv(this[n][jt]), this[j].id = e, this[j]._layer = this, this[s] = x, this[bt] = x, this[St] = x,
            this[z] = H, u = t._.newElement(this.id, this[j], ut, 1), u.onAttach = function() {
                var e = this[$t]._layer;
                e[Z]() || e.init(), e.resume()
            },
            u.onDetach = function() {
            ...
            this[n].states && this[n].states != t._.sd ? (t._.cacheElement(u), o = t._[un](this[n].states),
                t._[Ht](o, function(e) {
                    t._.addCachedElementToState(o[e], u)
                })) : this[n].breakpoints ? (t._.cacheElement(u),
                o = t._[un](this[n].breakpoints), t._[Ht](o, function(e) {
    ...
    return typeof e == gt ? H : (e.fn[p] = function() {
            ...
            return n = e(this), n[S](it, n.data(A))
                .data(A, ""), n
        },
        e.fn[Ct] = function() {
            var t = e(this),
        ...
        e.fn[lt] = function() {
            var t = e(this);
            t[At]("class")
                .match(/(\s+|^)([0-9]+)u(\s+|$)/) && t.data(Jt, parseInt(RegExp.$2))
        },
        e.fn[c] = function(r) {
            var i, s, o;
            if (this[U] > 1) {
            ...
            return s = e(this),
                isNaN(o = parseInt(s.data(rt))) && (o = 0), s.data(A, s[S](it))[S](it, t[n].baseZIndex + o + (r ? r : 1)), s
        }, e.fn[f] = function() {
            var t = e(this);
            return e(this)[Ot]("form")
                .each(function() {
                    this.reset()
                }), t
        },
        ...
        cn[C][ft] = {
            ...
            overlayX: {
                show: function(e) {
                    var r = e[n],
                        i = e[s];
                    i[B](0)[c](r.zIndex)[S](r[en],
                        Kt + t[K](t._[w](r[E])) + Gt)[rn](), r[$] && i[f](), t[Bt](fn), e[d](), window[v](function() {
            ...
            overlayY: {
                show: function(e) {
                    var r = e[n],
                        i = e[s];
                    i[B](0)[c](r.zIndex)[S](r[en], Kt + t[K](t._[w](r[R])) + Gt)[rn](), r[$] && i[f](), t[Bt]("y"), e[d](),
                        window[v](function() {
            ...
            e = this, r = this[n], o = t._[w](r[et]), a = this[s], a[S](E, t._[w](r[E]))[S](R, t._[w](r[R])), t._.vars[Mt] == "ios" && (r[R] == "100%" && !r[nt] && a[S](R, "-webkit-calc(" + t._[w](r[R]) + " + 70px)"), a.on(Nt, "input,select,textarea", function(n, r) {
                ...
                })), f = this[xt][r[b]], a[Dt]("skel-layer-" + r[b])
                .data(st, r[b]);
            switch (f.v) {
                case q:
                    a[S](q, 0);
            ...
            i[M](), i[Ot](on)
                ...
                .data(rt, this.index)[S](it, t[n].baseZIndex)[S](b, "fixed")[S]("-ms-overflow-style", "-ms-autohiding-scrollbar")[S]("-webkit-overflow-scrolling", "touch")[It]();
            ...
            r.clickToHide && i[Ot]("a")[S](Y, zt)
                ...
                .on("touchmove", function(e) {
                    ...
                    t = o[bt] - e[tt][Zt][0].pageX, n = o[St] - e[tt][Zt][0].pageY, s = i.outerHeight(), u = i.get(0)
                        .scrollHeight - i[B]();
            ...
            getBaseFontSize: function() {
                return t._.vars.IEVersion < 9 ? 16.5 : parseFloat(getComputedStyle(t[i][Qt].get(0))
                    .fontSize)
            },
            getHalf: function(e) {
                var t = parseInt(e);
            ...
            parseInit: function(n) {
                ...
                switch (u) {
                    ...
                    case "moveElement":
                        f = e(an + a[0]), o[l] = function() {
                            e(X + f[At]("id") + '" />')
                                .insertBefore(f), n[ht](f), f[Dt](_)
                        }, o[N] = function() {
                            e(at + f[At]("id"))
                                .replaceWith(f), f[Xt](_), t.refresh(f)
                        }, o[l]();
                        break;
                    case "moveCell":
                        f = e(an + a[0]), c = e(an + a[1]), o[l] = function() {
                            e(X + f[At]("id") + '" />')
                                .insertBefore(f), n[ht](f), f[S](E, Ft), c && c[Ct]()
                        }, o[N] = function() {
                            e(at + f[At]("id"))
                                .replaceWith(f), f[S](E, ""), c && c[S](E, "")
                        }, o[l]();
                        break;
                    default:
                }
            ...
            initObjects: function() {
                t[i][wt] = e(window), t._[Pt](function() {
                    t[i][jt] = e(jt),
                        t[i][Qt] = e(Qt), t[i][ln] = e("html,body"), t[i][Qt].wrapInner('<div id="skel-layers-wrapper" />'),
                        t[i][L] = e("#skel-layers-wrapper"), t[i][L][S](b, nn)[S](k, "0")[S](g, "0")[S](q, "0")[M](),
                        t[i][P] = e('<div id="skel-layers-hiddenWrapper" />')[Vt](t[i][Qt]), t[i][P][S](R, "100%"), t[i][u] = e('<div id="skel-layers-visibleWrapper" />')[Vt](t[i][Qt]), t[i][u][S](b, nn), t._[vt](ut, t[i][P][0]), t._[vt]("skel_layers_visibleWrapper", t[i][u][0]), t._[vt]("skel_layers_wrapper",
                            t[i][L][0]), e("[autofocus]")
                        .focus()
                })
            },
            initTransforms: function() {
                if (t[n][I]) e.fn[r] = function() {
                    ...
                    t[i][wt].resize(function() {
                        ...
                        var o, f, l, c;
                        r = parseInt(r), s = parseInt(s), r != 0 ? (t[i][Qt][S](D, nt), t[i][L][S](E,
                            t[i][wt][E]())) : l = function() {
